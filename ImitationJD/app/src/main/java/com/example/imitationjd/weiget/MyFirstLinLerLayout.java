 ...
 * @auther gaoxiaoxiong
 * @Descriptiion 用于first activity
 **/
public class MyFirstLinLerLayout extends LinearLayout implements NestedScrollingParent3 {
    private String TAG = MyFirstLinLerLayout.class.getSimpleName();
    ...
    public void setFirstActivity(AppCompatActivity firstActivity) {
        //ViewModelStore
        MyViewModel myViewModel = new ViewModelProvider(firstActivity.getViewModelStore(),
                ViewModelProvider.AndroidViewModelFactory.getInstance(firstActivity.getApplication()))
...
//        ViewModelProvider.Factory
    ...
    public MyFirstLinLerLayout(Context context) {
        super(context);
        this.mContext = context;
    }

    public MyFirstLinLerLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }

    public MyFirstLinLerLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
