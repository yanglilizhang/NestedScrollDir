...
public class ElemeNestedScrollLayout extends FrameLayout implements NestedScrollingParent2 {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        ViewGroup.LayoutParams params = mLlContent.getLayoutParams();//滑动内容
...
//    clamp( value, min, max) ：判断当前值是否位于最大值和最小值之间
//    如果 value 在最大值和最小值之间，则返回 value 的值，如果 value 比最小值还小，则返回 min 值，如果比最大值还大，则返回 max 值。
