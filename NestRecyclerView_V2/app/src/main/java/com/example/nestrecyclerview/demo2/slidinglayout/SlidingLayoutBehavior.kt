...
class SlidingLayoutBehavior : CoordinatorLayout.Behavior<SlidingLayout>() {
    ...
    override fun onMeasureChild(
        ...
        child.measure(
            ...
            View.MeasureSpec.makeMeasureSpec(
                View.MeasureSpec.getSize(parentHeightMeasureSpec) - childOffset,
    ...
    private fun scrooll(parent: CoordinatorLayout, child: SlidingLayout, dy: Int): Int {
        ...
        val scollDistance = Math.min(
            Math.max(initOffset, child.top - dy),
            parent.height - child.headerHeight * i
        ) - child.top
